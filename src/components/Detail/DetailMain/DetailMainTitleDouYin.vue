  ...
  <div class="detail-main-title">
    <div class="main-title-synopsis">
      ...
      <ul>
        ...
        <li>
          <img src="../../../assets/image/detail/weizhi.png" alt="" />
          <p>天津</p>
        </li>
        <li>
          <span>ID：</span>
      ...
      <img
        src="../../../assets/image/detail/synopsis-douyin.png"
        alt=""
        class="synopsis-douyin"
      />
    </div>
...
.detail-main-title {
  ...
  .main-title-link {
    ...
    display: flex;
    line-height: 48px;
    background: url(../../../assets/image/detail/link-douyin.png);
    background-size: 100%;
    border-radius: 4px;
    p:nth-child(1) {
      width: 530px;
